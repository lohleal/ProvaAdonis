...
export default function EntradaSaida(props) {
  ...
  return (
    <>
      {mostrarModalTabela && (
        <ModalCentralizado>
          <BotaoFechar onClick={() => {setMostrarModalTabela(false); props.onFecharTabela()}}>
          ...
          <ContainerPesquisa>
            ...
            <BotaoEspacado>
              ...
              <BotaoAcao onClick={() => abrirModal('saida', '')}>Saída
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5c4033">
        ...
        <ModalFundoTransparente>
          <ModalCentralizado>
            ...
            <FormularioModal>
              ...
              <LabelTextarea>Motivo: <textarea rows="3" defaultValue={itemSelecionado?.motivo || ''} /></LabelTextarea>
