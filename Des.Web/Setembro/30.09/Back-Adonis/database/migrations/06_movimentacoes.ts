...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('conta_origem_id').unsigned().nullable().references('id').inTable('contas_correntes')
      table.integer('conta_destino_id').unsigned().nullable().references('id').inTable('contas_correntes')
